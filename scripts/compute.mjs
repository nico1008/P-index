...
export const TRANSFORMS = {
  ...
  pressfreedom: (v) => clamp(100 - v, 0, 100),
  corruption:   (v) => clamp(100 - v, 0, 100),
  wages:        (v) => clamp((6 - v) * 10, 0, 100),
  keyrate:      (v) => clamp((v - 5) / 20 * 100, 0, 100),
  defense:      (v) => clamp((v - 2.5) / 6 * 100, 0, 100),
};
...
export const TRANSFORM_DOCS = {
  ...
  pressfreedom: '100 − rsf_score',
  corruption:   '100 − cpi_score',
  wages:        'clamp((6 − real_wage_yoy_pct) × 10, 0, 100)',
  keyrate:      'clamp((policy_rate_pct − 5) ÷ 20 × 100, 0, 100)',
  defense:      'clamp((defense_pct_gdp − 2.5) ÷ 6 × 100, 0, 100)',
};
